...
/**
 * @brief  return angle difference to goal to check if the goal orientation has been
 * achieved
 * @param  global_pose The pose of the robot in the global frame
 * @param  goal_x The desired x value for the goal
 * @param  goal_y The desired y value for the goal
...
/**
 * @brief  Transforms the global plan of the robot from the planner frame to the frame of
 * the costmap,
 ...
 * @param local_area_radius The radius of the local area around the robot considered by
 * the planner
 ...
 * @param rot_stopped_vel The rotational velocity below which the robot is considered
 * stopped
 * @param trans_stopped_vel The translational velocity below which the robot is considered
 * stopped
 ...
 * @param base_odom The current odometry information for the robot
 * @param rot_stopped_velocity The rotational velocity below which the robot is considered
 * stopped
 * @param trans_stopped_velocity The translational velocity below which the robot is
 * considered stopped
