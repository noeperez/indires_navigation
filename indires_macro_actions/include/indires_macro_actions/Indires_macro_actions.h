...
public:
  ...
  Indires_macro_actions(tf2_ros::Buffer* tf);
  ...
  // void robotPoseCallback(const geometry_msgs::PoseWithCovarianceStamped::ConstPtr&
  // msg);
  ...
  // bool reconfigureParameters(std::string node, std::string param_name, std::string
...
private:
  ...
  // *dsrv_;
  // void reconfigureCB(upo_navigation_macro_actions::NavigationMacroActionsConfig
