...
namespace RRT
{
	class StateSpace
	{
		public:
			...
			StateSpace(StateChecker* stateChecker, unsigned int dim, unsigned int dim_type, float sx, float sy, float sz = 0.0, float xyzres = 0.1, float yawres = 0.02, 
		...
		private:
			...
			//if dimensions = 3, type 1-> X,Y,th  type 2->X,Y,Z
			unsigned int				type_;
